...
if(isset($_POST)){
    ...
    $testTemplatePath = "../../testTemplatesJSON/test".$testId.".json";
    $testFile = json_decode(file_get_contents($testTemplatePath));
    $testQuestions = $testFile->questions;
    ...
    foreach($testQuestions as $qid => $question){
        $studentAnswer = $allAnswers[$qid];
